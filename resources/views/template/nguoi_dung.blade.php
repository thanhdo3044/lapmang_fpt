            ...
            <div class="row title">
                ...
                <div class=" col-12 row ">
                    <div class="col-3 d-flex justify-content-center align-items-center">
                        <img  src="{{ asset('nguoi_dung/img/logofptmobile.png') }}" alt="logofptmobile" width="146" height="48" /> 
                    </div>
                ...
                <div class="col-12  d-flex justify-content-end align-items-end ">
                    <a class="login-logout" href="{{ route('auth.index') }}">Đăng nhập</a> <a class="login-logout"> | </a> <a class="login-logout" href="{{ route('auth.dang_ky') }}" >	Đăng ký </a>  
                </div>
            </div>
        ...
        <div class="footer">
            <div class="row">
                <div class="  col-4 d-flex justify-content-center align-items-center image-container">
                    <img src="{{ asset('nguoi_dung/img/logofptmobile.png') }}" alt="logofptmobile" width="250" class="img-footer-start" /> 
                </div>
                <div class="col-4 row footer-center">
                    <div class="col-12"><h3>Trụ sở :</h3></div>
                    <a href="https://maps.app.goo.gl/EgFGRCeTu23eCLSAA" class="col-12"> <i class="fas fa-location-arrow"></i> Hà Nội: Đội 7-khu 3-thôn Văn Lôi - xã Tam Đồng - huyện Mê Linh - Hà Nội</a>
                    <a href="https://maps.app.goo.gl/tvYVxTEtfnjzoMDSA" class="col-12"> <i class="fas fa-location-arrow"></i> Hà Nội: Tòa nhà PVI, số 1 Phạm Văn Bạch, Cầu Giấy</a>
                    <a href="https://maps.app.goo.gl/AY1tEdSsNfUKeDmp7" class="col-12"><i class="fas fa-location-arrow"></i> Đà Nẵng: 182 - 184 Đường 2 tháng 9, Hải Châu</a>
                    <a href="https://maps.app.goo.gl/bgRS84D1KK9T4HZ26" class="col-12"><i class="fas fa-location-arrow"></i> TP. HCM: Lô 37-39A, đường 19, KCX Tân Thuận, Phường Tân Thuận Đông, Quận 7</a>
    
                </div>
                <div class="col-4 d-flex justify-content-center align-items-center image-container">
                    <iframe class="footer-end" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3719.74291387615!2d105.68703787477385!3d21.20236938179401!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3134feaca1c9a91f%3A0x49da2c9ab147bd4a!2zU8OibiBW4bqtbiDEkOG7mW5nIFRow7RuIFbEg24gTMO0aQ!5e0!3m2!1svi!2s!4v1710515367206!5m2!1svi!2s" width="auto" height="auto" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
        </div>
        ...
        <div  style="color: #000080;" id="DienThoai" >
            ...
            <div class="icon_lienhe" id="id_chat_lieuhe" >
                <a href="https://www.facebook.com/profile.php?id=100000930934345&mibextid=dGKdO6">
                    <img src="{{ asset('nguoi_dung/img/2023_Facebook_icon.svg.png') }}" width="38" alt="icon face" />
                </a>
            </div>
